/* SVD with NVIDIA CULA callable from matlab with Mex Socket Server
Sergey Voronin, 2015
*/
...
void singular_value_decomposition_cula(mat *M, mat **U, mat **S, mat **Vt){
    int i,m,n,k;
    m = M->nrows; n = M->ncols;
    k = min(m,n);
